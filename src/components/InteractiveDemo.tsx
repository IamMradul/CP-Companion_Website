    ...
    <section id="demo" className="py-24 relative z-10 bg-[#EAEAEA] border-t border-black/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-black tracking-tight font-heading">
        ...
        <div className="max-w-5xl mx-auto bg-white rounded-2xl overflow-hidden border border-black/15 shadow-xl">
          ...
          {activeTab === 'widget' && (
            <div className="p-8 md:p-12 bg-[#F8F8F6] flex flex-col items-center justify-center min-h-[420px] relative">
              <div className="text-center space-y-2 mb-8 relative z-10">
                <span className="text-xs font-mono text-black uppercase tracking-widest bg-black/5 border border-black/10 px-3 py-1 rounded-full font-semibold">
              ...
              {/* The Widget Box */}
              <div className="relative z-10 w-full max-w-sm bg-white p-6 rounded-2xl border-2 border-black/80 shadow-2xl transition-all cursor-move group">
                ...
                <div className="space-y-3 text-left">
                  <div className="text-base font-bold text-black leading-snug font-heading">
                  ...
                  <div className="py-2.5 px-3 rounded-xl bg-[#F4F4F0] border border-black/10 flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-2xl font-extrabold font-mono text-black tracking-tight">
          ...
          {activeTab === 'calendar' && (
            <div className="p-6 bg-white min-h-[420px]">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-[11px] font-mono text-black/60">Timezone: Local System Time</div>
              </div>

              <div className="grid grid-cols-7 text-center text-[11px] font-mono text-black/60 pb-2 border-b border-black/10">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between text-[10px] font-mono">
                        ...
                        {isToday && <span className="text-[9px] bg-black text-white px-1 rounded font-sans">Today</span>}
                      </div>

                      <div className="flex flex-wrap gap-1 mt-1">
                        {hasCodeforces && (
                          <span className="w-2 h-2 rounded-full bg-blue-600" title="Codeforces Contest" />
                        )}
                        {hasLeetCode && (
                          <span className="w-2 h-2 rounded-full bg-amber-500" title="LeetCode Contest" />
                        )}
                        {hasAtCoder && (
                          <span className="w-2 h-2 rounded-full bg-purple-600" title="AtCoder Contest" />
                        )}
                      </div>
                    </div>
                  );
          ...
          {/* Footer Bar */}
          <div className="bg-[#F4F4F0] px-6 py-3 border-t border-black/10 flex items-center justify-between text-xs text-black/70 font-mono">
